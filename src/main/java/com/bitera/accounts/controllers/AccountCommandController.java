...
import com.bitera.accounts.services.commands.AccountCommandService;
...
@Api(value = "Account Commands", description = "Endpoints para comandos de Accounts", tags = "Account Commands")
